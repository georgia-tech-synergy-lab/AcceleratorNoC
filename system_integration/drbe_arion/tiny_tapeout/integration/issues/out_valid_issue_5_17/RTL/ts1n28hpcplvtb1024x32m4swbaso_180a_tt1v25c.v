...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS1N28HPCPLVTB1024X32M4SWBASO_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS1N28HPCPLVTB1024X32M4SWBASO_fault.cde";
`endif
...
`ifdef UNIT_DELAY
parameter tSDQ = 0.2970;
parameter tSLPQ = 0.2970;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.4001;
    ...
    specparam tDS = 0.0595;
    specparam tDH = 0.0503;
    specparam tCD = 0.3063;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.3063;
`else    
    specparam tHOLD = 0.2441;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 5.8327;
    specparam tSDWK2CLK = 5.8327;
    specparam tSD = 0.4001;
    specparam tXSD = 0.1815;
    specparam tSDX = 0.3468;
    specparam tSDQ = 0.2970;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.3747;
    specparam tSLPWK2CLK = 0.3747;
    specparam tSLP = 0.4001;
    specparam tXSLP = 0.1815;
    specparam tSLPX = 0.3440;
    specparam tSLPQ = 0.2970;
    ...
    specparam tDMS = 0.0595;
    specparam tDMH = 0.0503;
    specparam tBWS = 0.0678;
    specparam tBWH = 0.0492;
    specparam tBWMS = 0.0678;
    specparam tBWMH = 0.0492;


    specparam tAWTQ = 0.1003;
    specparam tAWTQH = 0.0642;
