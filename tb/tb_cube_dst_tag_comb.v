`timescale 1ns / 1ps
/////////////////////////////////////////////////////////////
// Top Module:  tb_cube_dst_tag_comb
...
//                                                        
//              
//        CONNECTION FUNCTION                          CUBE2          CUBE1  
...
module tb_cube_dst_tag_comb();
    ...
    begin
        ...
        i_en = 1'b0;
        i_cmd = {3'b001,3'b000,3'b011,3'b010,3'b101,3'b100,3'b111,3'b110};
        ...
        i_data_bus = {{(DATA_WIDTH>>2){4'h7}},{(DATA_WIDTH>>2){4'h6}},{(DATA_WIDTH>>2){4'h5}},{(DATA_WIDTH>>2){4'h4}},{(DATA_WIDTH>>2){4'h3}},{(DATA_WIDTH>>2){4'h2}},{(DATA_WIDTH>>2){4'h1}},{(DATA_WIDTH>>2){4'h0}}};
        i_en = 1'b1;
        i_cmd = {3'b111,3'b110,3'b101,3'b100,3'b011,3'b010,3'b001,3'b000};
