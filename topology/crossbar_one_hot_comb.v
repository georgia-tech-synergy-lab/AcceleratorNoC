            ...
            begin:first_stage
                ...
                if(i_en)
                    case(inner_cmd_wire)
                        8'b00000001:
                        begin
                            inner_first_stage_data_reg[j*DATA_WIDTH+:DATA_WIDTH] = i_data_bus[(0+j*NUM_IN_MUX_FIRST_STAGE)*DATA_WIDTH+:DATA_WIDTH];
                            inner_first_stage_valid_reg[j] = 1'b1;
                        end
                        8'b00000010:
                        begin
                            inner_first_stage_data_reg[j*DATA_WIDTH+:DATA_WIDTH] = i_data_bus[(1+j*NUM_IN_MUX_FIRST_STAGE)*DATA_WIDTH+:DATA_WIDTH];
                            inner_first_stage_valid_reg[j] = 1'b1;
                        end
                        8'b00000100:
                        begin
                            inner_first_stage_data_reg[j*DATA_WIDTH+:DATA_WIDTH] = i_data_bus[(2+j*NUM_IN_MUX_FIRST_STAGE)*DATA_WIDTH+:DATA_WIDTH];
                            inner_first_stage_valid_reg[j] = 1'b1;
                        end
                        8'b00001000:
                        begin
                            inner_first_stage_data_reg[j*DATA_WIDTH+:DATA_WIDTH] = i_data_bus[(3+j*NUM_IN_MUX_FIRST_STAGE)*DATA_WIDTH+:DATA_WIDTH];
                            inner_first_stage_valid_reg[j] = 1'b1;
                        end
                        8'b00010000:
                        begin
                            inner_first_stage_data_reg[j*DATA_WIDTH+:DATA_WIDTH] = i_data_bus[(4+j*NUM_IN_MUX_FIRST_STAGE)*DATA_WIDTH+:DATA_WIDTH];
                            inner_first_stage_valid_reg[j] = 1'b1;
                        end
                        8'b00100000:
                        begin
                            inner_first_stage_data_reg[j*DATA_WIDTH+:DATA_WIDTH] = i_data_bus[(5+j*NUM_IN_MUX_FIRST_STAGE)*DATA_WIDTH+:DATA_WIDTH];
                            inner_first_stage_valid_reg[j] = 1'b1;
                        end
                        8'b01000000:
                        begin
                            inner_first_stage_data_reg[j*DATA_WIDTH+:DATA_WIDTH] = i_data_bus[(6+j*NUM_IN_MUX_FIRST_STAGE)*DATA_WIDTH+:DATA_WIDTH];
                            inner_first_stage_valid_reg[j] = 1'b1;
                        end
                        8'b10000000:
                        begin
                            inner_first_stage_data_reg[j*DATA_WIDTH+:DATA_WIDTH] = i_data_bus[(7+j*NUM_IN_MUX_FIRST_STAGE)*DATA_WIDTH+:DATA_WIDTH];
                            inner_first_stage_valid_reg[j] = 1'b1;
                        end
                        8'b00000000:
                        begin
