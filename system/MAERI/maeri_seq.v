...
/*
    ...
    Function:     For 8 multiplier;
       ...
       i_data_bus[2*DATA_WIDTH+:DATA_WIDTH]  -->|¯¯¯|-/ \/--->|¯¯¯|--/ \-->|¯¯¯|--/ \-->|¯¯¯|---\/ \->|¯¯¯|-----| |  |_x_|   \__________  |                         \
       i_data_bus[3*DATA_WIDTH+:DATA_WIDTH]  -->|___|-\ /\ /->|___|------->|___|------->|___|-\ /\ /->|___|-------|    |                \ /                          \--|¯¯¯|
                                        ID:       1    X  X     5            9            13   X  X     17             |                 X  forward links               | + |---> o_data_bus
       i_data_bus[4*DATA_WIDTH+:DATA_WIDTH]  -->|¯¯¯|-/ \/ \->|¯¯¯|------->|¯¯¯|------->|¯¯¯|-/ \/ \->|¯¯¯|-------|    v      __________/ \                          /--|___|     [3*DW+:DW]
