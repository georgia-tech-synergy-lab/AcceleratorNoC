`timescale 1ns / 1ps
/////////////////////////////////////////////////////////////
// Top Module:  distribute_1x2_dst_tag_multicast_comb
...
module distribute_1x2_dst_tag_multicast_comb#(
			...
			begin
				case({i_cmd[IN_COMMAND_WIDTH-1]})
					...
					begin
						o_data_bus_inner[DATA_WIDTH+:DATA_WIDTH] = (i_valid)?i_data_bus:{DATA_WIDTH{1'bz}};
						o_data_bus_inner[0+:DATA_WIDTH] = (i_valid)?i_data_bus:{DATA_WIDTH{1'bz}};
						o_valid_inner = (i_valid)?2'b11:2'b00;
					end
					default:
					begin
						o_valid_inner = 2'b00;
			...
			begin
				case(i_cmd[IN_COMMAND_WIDTH-1])
					...
					begin
						...
						o_cmd_inner = { i_cmd[DESTINATION_TAG_WIDTH-2:0], i_cmd[DESTINATION_TAG_WIDTH-2:0]};
					end
					default:
					begin
						o_valid_inner = 2'b00;
