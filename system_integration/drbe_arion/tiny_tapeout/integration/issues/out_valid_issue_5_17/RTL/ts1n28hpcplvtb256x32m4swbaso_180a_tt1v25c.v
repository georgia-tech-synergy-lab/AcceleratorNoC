...
//*# Library Name   : ts1n28hpcplvtb256x32m4swbaso (user specify : TS1N28HPCPLVTB256X32M4SWBASO)				*/
//*# Library Version: 180a												*/
//*# Generated Time : 2021/03/15, 13:47:12										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
module TS1N28HPCPLVTB256X32M4SWBASO (
            SLP,
            SD,
            CLK, CEB, WEB,
            CEBM, WEBM,
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS1N28HPCPLVTB256X32M4SWBASO_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS1N28HPCPLVTB256X32M4SWBASO_fault.cde";
`endif
...
`ifdef UNIT_DELAY
parameter tSDQ = 0.2730;
parameter tSLPQ = 0.2730;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.3297;
    specparam tCKH = 0.0700;
    specparam tCKL = 0.1036;
    ...
    specparam tDS = 0.0594;
    specparam tDH = 0.0503;
    specparam tCD = 0.2277;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.2277;
`else    
    specparam tHOLD = 0.1796;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 5.4493;
    specparam tSDWK2CLK = 5.4493;
    specparam tSD = 0.3297;
    specparam tXSD = 0.1815;
    specparam tSDX = 0.2833;
    specparam tSDQ = 0.2730;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.2659;
    specparam tSLPWK2CLK = 0.2659;
    specparam tSLP = 0.3297;
    specparam tXSLP = 0.1815;
    specparam tSLPX = 0.2802;
    specparam tSLPQ = 0.2730;
    specparam tSLPQH = 0.0000;

    specparam tBISTS = 0.1373;
    ...
    specparam tDMS = 0.0594;
    specparam tDMH = 0.0503;
    specparam tBWS = 0.0678;
    specparam tBWH = 0.0494;
    specparam tBWMS = 0.0678;
    specparam tBWMH = 0.0494;


    specparam tAWTQ = 0.1003;
    specparam tAWTQH = 0.0641;
