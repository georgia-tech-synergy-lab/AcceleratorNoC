...
module distribute_2x2_seq#(
	...
	always @(*) begin
		...
		begin	
			...
			begin //No Pass
				...
				dis_i_data_high_valid <= 1'b0;
				dis_i_data_low_ctrl  <= 2'b11; 
				dis_i_data_low_valid <= 1'b0;

				merge_i_data_high_ctrl <= 1'b0; 
				merge_i_data_high_valid <= 2'b00;
				merge_i_data_low_ctrl <= 1'b0;
				merge_i_data_low_valid <= 2'b00;
			end
			else
			begin
				case(i_cmd)
					...
					begin
						...
						dis_i_data_high_valid <= 1'b0;
						dis_i_data_low_ctrl  <= 2'b11; 
						dis_i_data_low_valid <= 1'b1;

						merge_i_data_high_ctrl <= 1'b0; 
						merge_i_data_high_valid <= 2'b01;
						merge_i_data_low_ctrl <= 1'b0;
						merge_i_data_low_valid <= 2'b01;
					end
					3'b011: //Pass Through
					begin
	...
	always @(posedge clk) begin
		...
		merge_i_data_low_valid_shift <= merge_i_data_low_valid;
		merge_i_data_high_valid_shift <= merge_i_data_high_valid;
	end
